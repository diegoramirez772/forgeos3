...
import { Zap, Copy, RefreshCw, Check, Shield, Key, Building2, ChevronRight } from 'lucide-react'
...
export function Settings() {
  ...
  const apiKey = 'fos3_sk_live_xxxxxxxxxxxxxxxxxxxxxxxx'
                    ...
                    <div className="p-5 space-y-4">
                      <div>
                        ...
                        <div className="flex gap-2">
                          ...
                          <button className="p-2.5 bg-forge-elevated border border-forge-border rounded-xl text-forge-subtle hover:text-forge-primary transition-colors">
                            <RefreshCw size={12} />
                          </button>
                        </div>
                      </div>
